...
PROJECT_ROOT_FROM_FILE = CURRENT_FILE.parents[1]
...
if TYPE_CHECKING:
    ...
    from rag.vector_retriever import (
...
class RagPipeline:
    ...
    def generate_answer(
        ...
        if not policy_decision.allowed:
            from rag.answer_generator import GeneratedAnswer
    ...
    def _check_answer_policy(
        ...
        from rag.answer_generator import check_answer_policy
...
def create_default_pipeline(
    ...
    if include_sql:
        try:
            from rag.sql_tool import SQLTool
