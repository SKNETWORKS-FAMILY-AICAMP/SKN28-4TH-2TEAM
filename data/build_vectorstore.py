...
옵션 예시:
    ...
    python build_vectorstore.py --project-root "C:/Users/Playdata/workspace/SKN28-third-2TEAM"
    python build_vectorstore.py --jsonl-path "C:/.../vector_documents.jsonl"
    python build_vectorstore.py --chroma-dir "C:/.../data/vectorstore/chroma_db"
...
DEFAULT_PROJECT_ROOT = Path(r"C:\Users\Playdata\workspace\SKN28-third-2TEAM")
DEFAULT_JSONL_REL_PATH = Path("data") / "processed" / "json" / "vector_documents.jsonl"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="vector_documents.jsonl 파일 경로. 생략하면 project-root/data/processed/vectorstore/vector_documents.jsonl 사용",
    )
