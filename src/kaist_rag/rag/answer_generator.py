...
15. 사용자가 KAIST 전체 학과를 묻는 것처럼 질문했지만 특정 학과나 정보 범위가 없으면, 현재 챗봇은 수집된 KAIST AI·자연과학·생명과학기술대학 학과만 안내한다고 먼저 밝히고 선택지를 제시하세요.
...
18. KAIST와 무관한 질문은 답변하지 말고 이 챗봇의 답변 범위가 KAIST 및 수집된 KAIST AI·자연과학·생명과학기술대학 학과 자료라고 안내하세요.
    ...
    def _build_ambiguity_instruction(
        ...
        instructions = {
            "department_scope": (
                ...
                "수집된 KAIST AI·자연과학·생명과학기술대학 학과만 안내 가능하다고 밝히고, 특정 학과 또는 전체 AI 관련 학과 비교 중 선택하게 하세요."
            ),
            "missing_department": (
            ...
            "off_topic": (
                "사용자가 KAIST와 무관한 정보를 요청하고 있습니다. 답변하지 말고 챗봇의 답변 범위가 KAIST 및 수집된 KAIST AI·자연과학·생명과학기술대학 학과 자료라고 안내하세요."
            ),
        }
