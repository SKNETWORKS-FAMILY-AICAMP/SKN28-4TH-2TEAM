...
from kaist_rag.rag.query_analyzer import (
    QueryAnalysis,
    QuestionAnalyzer,
...
if TYPE_CHECKING:
    from kaist_rag.rag.answer_generator import (
        AnswerGenerator,
        AnswerGeneratorConfig,
        GeneratedAnswer,
    )
    from kaist_rag.rag.context_builder import (
        BuiltContext,
        ContextBuilder,
        ContextBuilderConfig,
        SqlQueryResult,
    )
    from kaist_rag.rag.vector_retriever import (
...
class RagPipeline:
    ...
    def generate_answer(
        ...
        if not policy_decision.allowed:
            from kaist_rag.rag.answer_generator import GeneratedAnswer
    ...
    def _search_sql(self, analysis: QueryAnalysis) -> SqlQueryResult | None:
        ...
        try:
            ...
            from kaist_rag.rag.context_builder import SqlQueryResult
    ...
    def _get_context_builder(self) -> ContextBuilder:
        if self._context_builder is None:
            from kaist_rag.rag.context_builder import ContextBuilder
    ...
    def _check_answer_policy(
        ...
        from kaist_rag.rag.answer_generator import check_answer_policy
...
def create_default_pipeline(
    ...
    if include_sql:
        try:
            from kaist_rag.rag.sql_tool import SQLTool
